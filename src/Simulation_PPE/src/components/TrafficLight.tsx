...
const TrafficLight: React.FC<TrafficLightProps> = ({ 
  ...
  return (
    <div className="flex flex-col items-center mb-4 w-20">
      <div className="text-sm font-medium mb-1">Feu {id + 1}</div>
      ...
      <div className="mt-2 flex flex-col items-center">
        <span className="text-xs font-semibold mb-1">File:</span>
        <div className="flex h-4">
          {queueLength === 0 ? (
            <span className="text-xs text-green-500">Vide</span>
          ) : (
            <>
